<?php include_once 'template_principal/header.php'?>
<!-- Start Banner Hero -->
        ...
        <div class="row">
            <?php foreach ($data['categoria'] as $categoria) { ?>
                <div class="col-12 col-md-3 p-5 mt-3">
                    <a href="<?php echo BASE_URL . 'principal/categoria/' . $categoria['id_categoria'];?>"><img src="<?php echo $categoria['imagen'];?>" class="rounded-circle img-fluid border"></a>
        ...
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    ...
                    <p>
                        Estos son los ultimos productos que agregamos a la tienda.
...
<?php include_once 'template_principal/footer.php'?>