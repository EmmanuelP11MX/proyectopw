    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="list-inlile shop-top-menu pb-3 pt-1">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <center><a href="<?php echo BASE_URL . '/principal/detail/' . $producto['id_producto'];?>" class="h3 text-decoration-none"><?php echo $producto['nombre'];?></a></center>
