        ...
        <div class="col col-xl-10">
            ...
            <div class="row g-0">
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                    ...
                    <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Para continuar, inicia sesión en RLAB</h5>
                    ...
                    <a class="small text-muted" href="login.php?action=forgot">¿Olvidaste tu contraseña?</a>

                    <div class="pt-1 mb-4">
                        <input type="submit" name="enviar" value="Ingresar" class="btn btn-success btn-lg btn-block">
                    </div>
                    </form>
                </div>
                </div>
