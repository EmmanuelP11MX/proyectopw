...
class Sistema{
    ...
    public function forgot($destinatario, $token)
    {
        if ($this->validateEmail($destinatario)) {
            ...
            $mensaje = "Estimado usuario <br> <a href=\"http://localhost/rlab/admin/login.php?action=recovery&token=$token&correo=$destinatario\">Presiones aqui para recuperar la contaseña.</a> <br>
